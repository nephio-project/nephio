...
require (
	github.com/nephio-project/nephio/controllers/pkg v0.0.0-20230614145853-715bffbbfc2d
...
require (
	...
	github.com/henderiw-nephio/network v0.0.0-20230615061333-1031589193d0 // indirect
