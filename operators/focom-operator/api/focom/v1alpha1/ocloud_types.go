...
type OCloudSpec struct {
	// O2imsSecret references a Secret containing endpoint & credentials
	// +kubebuilder:validation:Required
	O2imsSecret O2imsSecret `json:"o2imsSecret"`
}
type O2imsSecret struct {
	// SecretRef points to the Secret with O2IMS credentials
	// +kubebuilder:validation:Required
...
func init() {
	SchemeBuilder.Register(&OCloud{}, &OCloudList{})
}
