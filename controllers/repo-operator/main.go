...
import (
	...
	"github.com/nephio-project/nephio/controllers/repo-operator/controllers"
...
func init() {
	...
	utilruntime.Must(porchconfigv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "311xghab.nephio.org",
	...
	gc := giteaclient.New(mgr.GetClient())
	go gc.Start(ctx)
