...
require (
	...
	github.com/nephio-project/nephio/krm-functions/interface-fn v0.0.0-20230508215739-b13457eda5c9
...
require (
	...
	github.com/nephio-project/api v0.0.0-20230503145925-bdf80c9b1256 // indirect
