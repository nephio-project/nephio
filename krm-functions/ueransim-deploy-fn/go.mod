...
require (
	...
	github.com/nephio-project/api v1.0.1-0.20250218114915-854faaf69fd0
	github.com/nephio-project/nephio/krm-functions/lib v0.0.0-20230627172556-8b92b80484c8
...
require (
	...
	github.com/nephio-project/porch v1.5.0 // indirect
